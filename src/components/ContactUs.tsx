    ...
    <section id="contact" className="py-16">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="flex items-start space-x-4">
              <div className="p-3 bg-gray-800 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#38BDF8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">BVCOE, Paschim Vihar, New Delhi, India</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            {submitStatus ? (
              <div className={`p-4 rounded-lg ${submitStatus.success ? 'bg-green-900/30 border border-green-500' : 'bg-red-900/30 border border-red-500'}`}>
